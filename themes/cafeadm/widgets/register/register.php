...
<article class="login">
    <div class="auth_content container content">
        <header class="auth_header">
            <h1>Cadastre-se</h1>
            <p>Já tem uma conta? <a title="Fazer login!" href="<?= url("/admin/login"); ?>">Fazer login!</a></p>
        </header>

        <form class="login_box radius" action="<?= url("/cadastrar"); ?>" method="post" enctype="multipart/form-data">
